...
from data.image_folder import make_dataset, make_dataset_frame_from_seq, make_dataset_frame_from_seq_test
from PIL import Image, ImageFilter


class FrameseqtestDataset(BaseDataset):
...
#         self.AB_paths = sorted(make_dataset(self.dir_AB, opt.max_dataset_size))  # get image paths
        ...
        self.A1_paths = sorted(make_dataset_frame_from_seq_test(self.dir_A1, opt.max_dataset_size))   # load images from '/path/train/ch-'
        self.A2_paths = sorted(make_dataset_frame_from_seq_test(self.dir_A2, opt.max_dataset_size))   
        self.B_paths = sorted(make_dataset_frame_from_seq_test(self.dir_B, opt.max_dataset_size)) 
