...
#             A1i = self.get_image(A1_path, transform_scaleA, is_label=self.A_is_label, is_single=True)
#             A2i = self.get_image(A2_path, transform_scaleA, is_label=self.A_is_label, is_single=True)
#             A3i = A2i.filter(ImageFilter.FIND_EDGES)   #the third channel is the edge of cyto   
#             Ai = Image.merge("RGB",(A1i,A2i,A3i))
